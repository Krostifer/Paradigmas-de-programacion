...
public class ListaEtiquetas {
    ...
    /**
     * Crea un largo String con la informacion de una etiqueta para que sea mostrada al momento de agregar etiquetas a una pregunta.
     * @return Largo String con la informacion de la etiqueta.
     */
    public String toStringAsk() {
        String etiquetasString = "Etiquetas: ";
        for(Etiqueta etiqueta: etiquetas) {
